...
public final class QuoteSyncJob {
    ...
    static void getQuotes(Context context) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                long number = quote.getAvgVolume();
                String avgVol = truncateNumber(number);

                float price = Float.parseFloat(new DecimalFormat(".2f").format(quote.getPrice().floatValue()));
                Timber.d("FLOAT.................."+String.valueOf(price));
    ...
    private static String truncateNumber(long number) {
